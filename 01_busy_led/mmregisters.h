...
volatile unsigned int* GPFSEL0 = (unsigned int*)0x20200000;
volatile unsigned int* GPFSEL1 = (unsigned int*)0x20200004;
volatile unsigned int* GPFSEL2 = (unsigned int*)0x20200008;
volatile unsigned int* GPFSEL3 = (unsigned int*)0x2020000C;
volatile unsigned int* GPFSEL4 = (unsigned int*)0x20200010;
volatile unsigned int* GPFSEL5 = (unsigned int*)0x20200014;

volatile unsigned int* GPSET0 = (unsigned int*)0x2020001C;
volatile unsigned int* GPSET1 = (unsigned int*)0x20200020;
volatile unsigned int* GPCLR0 = (unsigned int*)0x20200028;
volatile unsigned int* GPCLR1 = (unsigned int*)0x2020002C;
